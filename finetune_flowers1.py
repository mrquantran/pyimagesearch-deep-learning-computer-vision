...
from keras.api.optimizers import RMSprop, SGD
...
# load the dataset from disk then scale the 
...
model.export(args["model"])

# python finetune_flowers1.py --dataset ../datasets/flowers17/images --model ./output/flowers17.model