...
for epoch in np.arange(0, args["epochs"]):
    # take the dot product between our features 'X' and the weight matrix 'W', 
    # then pass this value through our sigmoid activation function, thereby giving us our predictions on the dataset
    ...
    # why the gradient is the dot product between the features and the error of the predictions?
