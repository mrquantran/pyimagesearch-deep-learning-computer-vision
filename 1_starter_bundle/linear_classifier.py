...
# initialize the class labels and set the seed of 
# the pseudorandom number generator so we can reproduce our results
...
orig = cv2.imread("munchinkin.jpg")
image = cv2.resize(orig, (32, 32)).flatten()

# compute the output scores by taking the dot product between
# the weight matrix and image pixels, followed by adding in the bias
